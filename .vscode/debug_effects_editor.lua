-- Local development launcher for attaching VS Code's LuaPanda debugger to
-- PAGER while the real editor continues to run inside REAPER.
...
local extension_prefix = 'antoinebalaine.reascript-docs-'
...
dofile(workspace .. '/editor/effects_editor.lua')
